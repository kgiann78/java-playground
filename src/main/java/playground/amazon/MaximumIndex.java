...
//        int[] A = {6, 6, 6, 1, 2, 4, 1};
    ...
    private static void getMaxDistanceFaster(int[] A) {
        ...
        System.out.println(max + " at " + (stop - start) + " ns");

    }

    private static void getMaxDistanceSlower(int[] A) {
        int max = 0;
